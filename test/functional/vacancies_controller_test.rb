...
class VacanciesControllerTest < ActionController::TestCase
  ...
  test "should create vacancy" do
    assert_difference('Vacancy.count') do
      post :create, vacancy: { first_day: @vacancy.first_day, last_day: @vacancy.last_day, period: @vacancy.period, title: @vacancy.title }
    end
  ...
  test "should update vacancy" do
    put :update, id: @vacancy, vacancy: { first_day: @vacancy.first_day, last_day: @vacancy.last_day, period: @vacancy.period, title: @vacancy.title }
    assert_redirected_to vacancy_path(assigns(:vacancy))
  end
